                ...
                <div class="row">
                    <div class="main main-content">
                        <div class="table-responsive">
                            <table class="table table-bordered tbl-user">                                                   
                                <thead>
                                    <tr class="info">
                                        ...
                                        <th class="tbl-right">Username</th>
                                        <th class="tbl-right">Email</th>
                                ...
                                <tbody>
                                    <c:forEach var="user" items="${users}">
                                        <tr class="info">
                                            ...
                                            <td>
                                                <a class="btn btn-primary" href="${base}/users/edituser/${user.id}">Edit</a>
                                            </td>
                                            <td>
                            ...
                            <a class="btn btn-primary" href="${base}/users/adduser">Add</a>
                        </div>
                    </div>
                </div>
            </div>
